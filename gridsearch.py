"""
Created on Thu Mar  5 18:44:53 2020
...
class DropoutModel:
    ...
    def __init__(self, layers, drop, drop_in):
        self.layers = layers
        self.dropout = drop
        self.dropout_in = drop_in
